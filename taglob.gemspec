...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "bin/taglob", "lib/taglob.rb", "lib/taglob/extensions.rb", "lib/taglob/extensions/dir.rb", "lib/taglob/extensions/file.rb", "lib/taglob/extensions/string.rb", "lib/taglob/rake.rb", "lib/taglob/rake/check_tags_task.rb", "lib/taglob/rake/tasks.rb", "lib/taglob/rake/test_tags_task.rb", "lib/taglob/spec/tag_html_formatter.rb", "spec/check_tags_task_spec.rb", "spec/dir_tagor_spec.rb", "spec/missing_tags.txt", "spec/spec_helper.rb", "spec/tagged_files/epic_lulz.rb", "spec/tagged_files/foo.rb", "spec/tagged_files/foo_bar_buttz.rb", "spec/taglob_spec.rb", "spec/tasks_spec.rb", "spec/test_tags_task_spec.rb", "spec/valid_tags.txt"]
  s.has_rdoc = true
